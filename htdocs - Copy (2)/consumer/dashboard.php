...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="simple_elegant_green_logo_for_Kisan_Bazar-removebg-preview[1].png" alt="Logo" style="height: 160px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="consumer_categories.php">Order</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="../consumerProfile/consumer_profile.php">👤</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <section id="about" class="container text-center mt-5 pt-5 section">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 position-relative">
                ...
                <a href="consumer_categories.php" class="btn btn-success mt-3">SHOP</a>
            </div>
        </div>
    </section>
