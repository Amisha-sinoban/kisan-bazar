...
$query = "SELECT * FROM orders WHERE farmer_id = ? AND status = 'pending'";
...
<body>
    ...
    <div class="content">
        ...
        <div class="parent-recieved">
            ...
            <?php endwhile; ?>
            <!-- <div class="recieved">
                <h2 id="orders">Order Recieved</h2>
                <p>Item: Chickpeas</p>
                <p>Quantity: 5 Kg</p>
                <p>Price: $2.00</p>
                <p>Duration: 2 days</p>
            ...
            <div class="recieved" id="AllOrders"><a href=" ">Check all orders</a><a href="acceptedOrdersPage">Check
                    orders you accepted recently </a></div>
